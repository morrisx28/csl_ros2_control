...
from hardware_dds_bridge.Motor_Manager_origin import *
...
class HardwareManager:
    def __init__(self, config_path):
        ...
        self.motor_manager = MotorManager(config_path)
...
def main():
    ...
    hardware_manager = HardwareManager(config_path)

    hardware_manager.run()
